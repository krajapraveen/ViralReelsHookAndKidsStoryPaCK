...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://webhook-retry-sys.preview.emergentagent.com').rstrip('/')
...
class TestPhase6Security:
    ...
    def test_cors_headers_present(self):
        ...
        response = requests.options(
            ...
            headers={"Origin": "https://webhook-retry-sys.preview.emergentagent.com"}
        )
