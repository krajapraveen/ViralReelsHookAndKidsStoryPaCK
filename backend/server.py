...
from routes.photo_trailer import router as photo_trailer_router, youstar_admin_router
...
# P0 2026-05-22 Phase A — Google Ads conversion truth.
# Attribution capture + activation + cashfree conversion-handshake.
...
api_router.include_router(youstar_admin_router)
