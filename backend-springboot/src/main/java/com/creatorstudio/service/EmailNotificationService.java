...
public class EmailNotificationService {
    ...
    private static final String LOGO_URL = "https://blueprint-lib.preview.emergentagent.com/logo.png";
        ...
        String htmlContent = buildEmailTemplate(
            ...
            String.format("""
                ...
                <div style="text-align: center; margin: 32px 0;">
                    <a href="https://blueprint-lib.preview.emergentagent.com/app" 
    ...
    public void sendReelGenerationComplete(User user, String topic, int creditsUsed) {
        ...
        String htmlContent = buildEmailTemplate(
            ...
            String.format("""
                ...
                <div style="text-align: center; margin: 32px 0;">
                    <a href="https://blueprint-lib.preview.emergentagent.com/app/history" 
                       style="display: inline-block; background: #6366f1; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold;">
                        View Your Script →
                    </a>
                </div>
    ...
    public void sendLowCreditAlert(User user, BigDecimal remainingCredits) {
        ...
        String htmlContent = buildEmailTemplate(
            ...
            String.format("""
                ...
                <div style="text-align: center; margin: 32px 0;">
                    <a href="https://blueprint-lib.preview.emergentagent.com/pricing" 
    ...
    public void sendAccountDeletionScheduled(User user, String reason) {
        ...
        String htmlContent = buildEmailTemplate(
            ...
            String.format("""
                ...
                <div style="text-align: center; margin: 32px 0;">
                    <a href="https://blueprint-lib.preview.emergentagent.com/app/privacy" 
                       style="display: inline-block; background: #6366f1; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: bold;">
                        Cancel Deletion →
                    </a>
                </div>
                                ...
                                <tr>
                                    <td style="background-color: #f8fafc; padding: 24px; text-align: center; border-top: 1px solid #e2e8f0;">
                                        ...
                                        <p style="margin: 0; color: #94a3b8; font-size: 12px;">
                                            ...
                                            <a href="https://blueprint-lib.preview.emergentagent.com/privacy-policy" style="color: #6366f1; text-decoration: none;">Privacy Policy</a> • 
                                            <a href="https://blueprint-lib.preview.emergentagent.com/contact" style="color: #6366f1; text-decoration: none;">Contact Us</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
