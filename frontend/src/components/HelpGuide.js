  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 right-6 z-40 w-12 h-12 bg-purple-600 hover:bg-purple-500 text-white rounded-full shadow-lg shadow-purple-500/30 flex items-center justify-center transition-all hover:scale-110"
      ...
      {isOpen && (
        <div 
          className="fixed bottom-40 right-6 z-40 w-80 max-h-[70vh] bg-slate-900 border border-slate-700 rounded-xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-2 fade-in duration-200"
