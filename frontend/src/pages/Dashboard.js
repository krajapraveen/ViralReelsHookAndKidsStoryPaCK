...
import { Sparkles, Video, BookOpen, Clock, LogOut, CreditCard, History as HistoryIcon, Coins, Shield, Lightbulb, Lock, User, Copyright, Wand2, Library, Receipt, Palette, Film, Calendar, Type, Crown, BarChart3, HelpCircle, TrendingUp, Flame, Gift, ChevronRight, Image as ImageIcon, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8 sm:mb-12">
          ...
          <Link to="/app/instagram-bio-generator">
            <div className="bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl p-4 sm:p-5 text-white hover:scale-[1.02] transition-transform cursor-pointer h-full" data-testid="quick-action-bio-generator">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-bold">Instagram Bio Generator</h3>
              </div>
              <p className="text-white/80 text-xs sm:text-sm">5 optimized bios with CTAs and emojis</p>
        ...
        <div className="mb-8 sm:mb-12 flex gap-4 sm:gap-6 flex-wrap">
          <Link to="/app/blueprint-library" className="inline-flex items-center gap-2 text-violet-400 hover:text-violet-300 transition-colors font-medium">
