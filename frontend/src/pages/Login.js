...
import AuthLaunchOverlay from '../components/AuthLaunchOverlay';
...
export default function Login({ setAuth }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-950 flex items-center justify-center p-4">
      {/* Full-screen branded overlay — shown on Google sign-in click */}
      {googleLoading && <AuthLaunchOverlay phase="launching" />}
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6">
            ...
            <Button
              ...
              className="w-full mt-4 bg-white hover:bg-gray-100 text-gray-900 rounded-xl py-6 text-lg flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-200"
