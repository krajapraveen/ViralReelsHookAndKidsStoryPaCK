    ...
    <div className="min-h-screen bg-slate-950">
      <header className="border-b border-slate-800/50 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <Button size="sm" onClick={() => navigate('/app/photo-to-comic')} className="bg-purple-600 hover:bg-purple-700">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6" data-testid="my-stories-page">
        {chains.length === 0 ? (
          <div className="text-center py-20 space-y-4">
            ...
            <Button onClick={() => navigate('/app/photo-to-comic')} className="bg-purple-600 hover:bg-purple-700">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4" data-testid="chains-grid">
            {chains.map((chain) => (
              <Link
                ...
                className="group block rounded-xl border border-slate-800 bg-slate-900/60 hover:border-purple-500/40 transition-all overflow-hidden"
