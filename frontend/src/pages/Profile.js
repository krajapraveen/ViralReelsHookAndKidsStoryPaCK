...
import { 
  ...
  CreditCard, Clock, Save, Camera, Trash2, Download,
...
export default function Profile() {
  ...
  const handleDeleteAccount = async () => {
    ...
    if (!window.confirm('All your data, generations, and credits will be permanently deleted. Type "DELETE" in the next prompt to confirm.')) {
      return;
    }
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2 border-b border-slate-100">
              <div>
                <div className="font-medium">Generation Alerts</div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
              ...
              <Button variant="outline" size="sm" onClick={handleExportData} data-testid="export-data-btn">
