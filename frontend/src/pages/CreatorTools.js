  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Comic Studio Promotion Banner */}
        <Link to="/app/comic-studio">
          <div className="bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 rounded-xl p-4 mb-6 flex items-center justify-between hover:scale-[1.01] transition-transform cursor-pointer">
            <div className="flex items-center gap-4">
              <span className="text-3xl">🎨</span>
              <div>
                <h3 className="text-white font-bold text-lg">NEW: Comic Studio</h3>
                <p className="text-white/80 text-sm">Turn your photos into comic panels - 8 genres, no AI cost!</p>
              </div>
            </div>
